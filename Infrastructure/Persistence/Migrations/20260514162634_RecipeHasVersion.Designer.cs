...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260514162634_RecipeHasVersion")]
    partial class RecipeHasVersion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.DayPlanEntry", b =>
                {
                    ...
                    b.ToTable("DayPlanEntries", t =>
                        {
                            t.HasCheckConstraint("CK_DayPlanEntry_RecipeVersionOrProductVersion", "(\"RecipeVersionId\" IS NOT NULL) != (\"ProductVersionId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.DayPlanEntry", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ProductVersion", "ProductVersion")
                        .WithMany()
